 ...
 *  @brief Brief description of file.
	this file is where all the information comes together for the costumer to inplement

 *  Longer description of file.
	This file has one of the requisites of the overload a cunstructor. Most of my requrements are in this file.
	This file will inplment all the information inputed by the users( admin and costumer)
	it will add the rooms added by the admin, check aailavility of the rooms acoring to the kind of room the costumer wants
	then it will check them in or out as the costumer prefer.
 *
